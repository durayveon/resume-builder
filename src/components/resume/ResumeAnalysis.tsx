...
export function ResumeAnalysis({ resumeData, jobDescription = '', onAnalysisComplete }: ResumeAnalysisProps) {
    ...
    return (
      <div className="text-center p-8 border-2 border-dashed rounded-lg">
        ...
        <p className="text-gray-600 mb-4">
          Get detailed feedback on your resume and improve your chances of getting noticed by recruiters.
        </p>
        <Button 
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white p-4 rounded-lg border">
        <h4 className="font-medium mb-3 flex items-center">
          ...
          <span className={`text-xs px-2 py-1 rounded-full ${result.atsCompatibility.score > 70 ? 'bg-green-100 text-green-800' : result.atsCompatibility.score > 40 ? 'bg-yellow-100 text-yellow-800' : 'bg-red-100 text-red-800'}`}>
        ...
        {result.atsCompatibility.issues.length > 0 && (
          <div className="mt-2 space-y-2">
            <p className="text-sm font-medium text-gray-700">Potential Issues:</p>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-1">
                {result.keywordMatch.missing.length > 0 ? (
                  ...
                  <p className="text-sm text-gray-500">All important keywords matched!</p>
                )}
              </div>
            </div>
          </div>
              ...
              <div className="flex justify-between items-start">
                <div className="flex-1">
                  <div className="flex items-center mb-1">
                    <span className={`text-xs font-medium px-2 py-0.5 rounded-full mr-2 ${getPriorityColor(improvement.priority)}`}>
                      {improvement.priority.charAt(0).toUpperCase() + improvement.priority.slice(1)} Priority
                    </span>
                    <span className="text-xs text-gray-500">{improvement.section}</span>
                  </div>
      ...
      {result.strengths.length > 0 && (
        <div className="bg-green-50 p-4 rounded-lg">
          <h4 className="font-medium text-green-800 mb-2">Your Resume's Strengths</h4>
