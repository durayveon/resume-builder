...
const features = [
  {
    ...
    description:
      'Create professional, ATS-optimized resumes in minutes with our AI-powered builder that highlights your skills and experience.',
    image: screenshotPayroll,
  },
  {
    title: 'Job Matching',
    description:
      'Get matched with the best job opportunities based on your skills, experience, and career goals using our advanced AI algorithms.',
    image: screenshotExpenses,
  },
  {
    title: 'Cover Letter Generator',
    description:
      'Generate personalized, compelling cover letters tailored to each job application with just a few clicks.',
